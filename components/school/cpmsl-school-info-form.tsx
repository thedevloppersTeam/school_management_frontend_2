    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-lg border border-neutral-200 shadow-sm">
        ...
        <div className="p-6 space-y-5">
          ...
          <div className="space-y-2">
            <Label htmlFor="logo-upload" className="text-sm font-medium text-neutral-900">
              Logo
            </Label>
            <div className="flex items-center gap-4 w-[60%]">
              <Avatar className="h-24 w-24 rounded-xl">
                {editedInfo.logo ? (
                  <AvatarImage src={editedInfo.logo} alt="Logo de l'école" className="object-cover" />
                ) : (
              ...
              <div className="flex-1">
                ...
                >
                  ...
                  <span className="text-sm text-neutral-500">Télécharger un logo</span>
                </label>
                <input
                  id="logo-upload"
                  type="file"
          ...
          {/* Nom */}
          <div className="space-y-2">
            <Label htmlFor="school-name" className="text-sm font-medium text-neutral-900">
              Nom de l&apos;école <span className="text-error" aria-label="obligatoire">*</span>
            </Label>
            <Input
              id="school-name"
          ...
          {/* Devise */}
          <div className="space-y-2">
            <Label htmlFor="school-motto" className="text-sm font-medium text-neutral-900">
              Devise
            </Label>
            <Input
              id="school-motto"
          ...
          <div className="space-y-2 w-1/4">
            <Label htmlFor="school-founded" className="text-sm font-medium text-neutral-900">
              Fondée en
            </Label>
            <Input
              id="school-founded"
      ...
      <div className="bg-white rounded-lg border border-neutral-200 shadow-sm">
        ...
        <div className="p-6 space-y-5">
          ...
          {/* Adresse */}
          <div className="space-y-2">
            <Label htmlFor="school-address" className="text-sm font-medium text-neutral-900">
              Adresse complète
            </Label>
            <Textarea
              id="school-address"
          ...
          {/* Téléphone */}
          <div className="space-y-2">
            <Label htmlFor="school-phone" className="text-sm font-medium text-neutral-900">
              Téléphone
            </Label>
            <Input
              id="school-phone"
          ...
          {/* Email */}
          <div className="space-y-2">
            <Label htmlFor="school-email" className="text-sm font-medium text-neutral-900">
              Email
            </Label>
            <Input
              id="school-email"
      ...
      <div className="flex justify-end">
        <Button
          ...
          title={isSaveDisabled && !saving ? "Le nom de l'école est obligatoire" : undefined}
