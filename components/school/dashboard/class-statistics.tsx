    ...
    switch (status) {
      case "complete":
        return (
          <Badge
            ...
            style={{ backgroundColor: "#E8F5EC", color: "#2D7D46" }}
          >
            Complet
          </Badge>
        )
      case "in-progress":
        return (
          <Badge
            className="font-medium border-0"
            style={{ backgroundColor: "#FEF6E0", color: "#C48B1A" }}
          >
            En cours
          </Badge>
        )
      case "not-started":
        return (
          <Badge
            className="font-medium border-0"
            style={{ backgroundColor: "#FDE8E8", color: "#C43C3C" }}
          >
            Non commencé
          </Badge>
        )
          ...
          <table className="w-full min-w-[600px]">
            <thead>
              <tr style={{ backgroundColor: "#F0F4F7" }}>
                {["Classe", "Effectif", "Notes saisies", "Moy. générale", `Statut — ${periodName}`].map(col => (
                  <th
                    key={col}
              ...
              {classes.map((classData, index) => (
                ...
                >
                  <td
                    ...
                    style={{ fontSize: "14px", fontWeight: 500, lineHeight: 1.5, color: "#1E1A17" }}
                  >
                    {classData.className}
                  </td>
                  <td
                    className="py-3 px-4 font-sans"
                    style={{ fontSize: "14px", fontWeight: 400, lineHeight: 1.5, color: "#5C5955" }}
                  >
                  ...
                  >
                    ...
                    ({getProgressPercentage(classData.gradesEntered, classData.totalGrades)}%)
                  </td>
                  <td
                    className="py-3 px-4 font-sans"
                    style={{ fontSize: "14px", fontWeight: 400, lineHeight: 1.5, color: "#1E1A17" }}
                  >
        ...
        {onViewAll && (
          <div className="mt-4 flex justify-end">
            <Button
              ...
              style={{ color: "#5A7085", fontSize: "14px" }}
            >
