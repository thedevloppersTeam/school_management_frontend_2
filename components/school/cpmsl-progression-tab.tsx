...
export function CPMSLProgressionTab({
  ...
  const inProgress = classProgress.filter(
    (c) => c.status === "in-progress",
  ).length;
  const notStarted = classProgress.filter(
    ...
    <div className="space-y-6">
      ...
      <Card className="border bg-card shadow-sm">
        <CardHeader className="pb-3">
          ...
          <CardDescription>
            Voir l&apos;avancement de la saisie pour une étape donnée
          </CardDescription>
        </CardHeader>
        <Separator />
            ...
            <CardHeader className="pb-3">
              <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                <div>
                  ...
                  <CardDescription>
                    {filteredProgress.length} classe
                        ...
                        <TableRow key={cp.sessionId}>
                          ...
                          <TableCell>
                            <Progress
                              value={cp.pct}
                              className={cn(
                                "h-2 w-full max-w-[220px]",
                                progressBarClass(cp.pct),
                              )}
                            />
                          </TableCell>
                          <TableCell>
                          ...
                          <TableCell>{renderStatusBadge(cp.status)}</TableCell>
                          <TableCell className="pr-6 text-right">
                            {cp.status !== "complete" && onNavigateToSaisie && (
                              <Button
                                ...
                                onClick={() =>
                                  onNavigateToSaisie(cp.sessionId, selectedStep)
                                }
                              >
                                Saisir
