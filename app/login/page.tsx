      ...
      >
        ...
        <div style={{ marginBottom: "24px" }}>
          <h1
            ...
            style={{ color: "#2A3740", marginBottom: "8px", fontSize: "28px", letterSpacing: "-0.025em", fontWeight: 700 }}
          >
            Connexion
          </h1>
          <p className="font-sans" style={{ fontSize: "13px", fontWeight: 400, color: "#78756F" }}>
        ...
        <form onSubmit={handleSubmit}>
          ...
          {/* Zone d'erreur — hauteur fixe pour éviter le layout shift */}
          ...
          <button
            ...
            onMouseEnter={e => { if (!isLoading) e.currentTarget.style.backgroundColor = "#4A5D6E" }}
            onMouseLeave={e => { if (!isLoading) e.currentTarget.style.backgroundColor = "#5A7085" }}
          >
            {isLoading && (
