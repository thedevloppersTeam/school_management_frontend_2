...
import { CPMSLGradesCsvImport } from "@/components/school/cpmsl-grades-csv-import"
  ...
  function renderMainContent() {
    ...
    return (
      <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
        ...
        {/* Import CSV — matching strict élève inscrit dans la classe + step */}
        <TabsContent value="import-csv">
          <CPMSLGradesCsvImport
            sessions={apiSessions}
            steps={steps}
          />
        </TabsContent>
